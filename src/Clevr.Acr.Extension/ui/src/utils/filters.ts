import { GENERIC_CATEGORY_FALLBACK, GENERIC_PREFIX_FALLBACK, MXCLI_CATEGORY_TO_ACR } from "../constants";
...
export function matches(v: Violation, q: string, ruleNames: Record<string, string>, ruleCategories: Record<string, string>): boolean {
  if (!q) return true;
  return [
    v.ruleId, v.acrCode, ruleNames[v.ruleId], v.category,
